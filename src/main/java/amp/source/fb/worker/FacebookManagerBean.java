...
import amp.source.fb.base.SourceManagerBean;
import amp.source.fb.impl.FacebookWorker;

/**
 * Session Bean implementation class FacebookWorkerBean
 */
@Singleton(name="FacebookManagerBean", mappedName = "FacebookManagerBean")
@LocalBean
@Startup
public class FacebookManagerBean extends SourceManagerBean 
{
