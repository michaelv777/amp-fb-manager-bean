...
public abstract class ThreadWorker 
{
	...
	//---
	protected boolean setItemOpStatus(String itemId, 
								   String description, 
							       String status,
								   String opTypeName) 
	{
		...
		try
		{
	        ...
	        */
	        ...
	        //String workerName  = ToolkitConstants.AMP_FACEBOOK_SOURCE_WORKER; 
										       ...
										       String opTypeName) 
	{
		...
		try
		{
    		...
    		WebResource webResource = client.resource(getDataBaseURI().toString());
